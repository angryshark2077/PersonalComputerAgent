...
CREATE TABLE communication_messages_new (
    ...
    FOREIGN KEY (account_id, external_conversation_id)
        REFERENCES communication_conversations_new(account_id, external_conversation_id)
        ON DELETE RESTRICT,
    CHECK (
...
CREATE TABLE communication_cursors_new (
    account_id TEXT NOT NULL,
    external_conversation_id TEXT NOT NULL,
...
INSERT INTO communication_conversations_new SELECT * FROM communication_conversations;
INSERT INTO communication_messages_new SELECT * FROM communication_messages;
INSERT INTO communication_cursors_new SELECT * FROM communication_cursors;
...
DROP TABLE communication_cursors;
...
ALTER TABLE communication_cursors_new RENAME TO communication_cursors;
